...
public class UltimateAdvancementAPICommand_v5_12 {
    ...
    public void register() {
        ...
        grant.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_GRANT_TAB).withArguments(new AdvancementTabArgument_v5_12(main, "advancementTab"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> grantTab(sender, (AdvancementTab) args[0], (Player) args[1], true)));
        grant.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_GRANT_TAB).withArguments(new AdvancementTabArgument_v5_12(main, "advancementTab"), new PlayerArgument("player"), new BooleanArgument("giveRewards")).executes((CommandSender sender, Object[] args) -> grantTab(sender, (AdvancementTab) args[0], (Player) args[1], (boolean) args[2])));
        ...
        grant.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_GRANT_ONE).withArguments(new AdvancementArgument_v5_12(main, "advancement"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> grantOne(sender, (Advancement) args[0], (Player) args[1], true)));
        grant.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_GRANT_ONE).withArguments(new AdvancementArgument_v5_12(main, "advancement"), new PlayerArgument("player"), new BooleanArgument("giveRewards")).executes((CommandSender sender, Object[] args) -> grantOne(sender, (Advancement) args[0], (Player) args[1], (boolean) args[2])));
        ...
        revoke.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_REVOKE_TAB).withArguments(new AdvancementTabArgument_v5_12(main, "advancementTab"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> revokeTab(sender, (AdvancementTab) args[0], (Player) args[1], false)));
        revoke.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_REVOKE_TAB).withArguments(new AdvancementTabArgument_v5_12(main, "advancementTab"), new PlayerArgument("player"), new BooleanArgument("hideTab")).executes((CommandSender sender, Object[] args) -> revokeTab(sender, (AdvancementTab) args[0], (Player) args[1], (boolean) args[2])));
        ...
        revoke.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_REVOKE_ONE).withArguments(new AdvancementArgument_v5_12(main, "advancement"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> revokeOne(sender, (Advancement) args[0], (Player) args[1])));
        ...
        criteria.withSubcommand(new CommandAPICommand("get").withPermission(PERMISSION_CRITERIA_GET).withArguments(new AdvancementArgument_v5_12(main, "advancement"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> getCriteria(sender, (Advancement) args[0], (Player) args[1])));
        ...
        criteria.withSubcommand(new CommandAPICommand("set").withPermission(PERMISSION_CRITERIA_SET).withArguments(new AdvancementArgument_v5_12(main, "advancement"), new IntegerArgument("criteria", 0), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> setCriteria(sender, (Advancement) args[0], (int) args[1], (Player) args[2], true)));
