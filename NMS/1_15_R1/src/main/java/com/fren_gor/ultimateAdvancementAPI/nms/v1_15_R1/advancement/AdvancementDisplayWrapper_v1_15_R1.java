...
public class AdvancementDisplayWrapper_v1_15_R1 extends AdvancementDisplayWrapper {
    ...
    public AdvancementDisplayWrapper_v1_15_R1(@NotNull ItemStack icon, @NotNull String title, @NotNull String description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean hidden, @Nullable String backgroundTexture) {
    ...
    public String getTitle() {
        return ((ChatComponentText) display.a()).i();
    }

    @Override
    @NotNull
    public String getDescription() {
        return ((ChatComponentText) display.b()).i();
    }
