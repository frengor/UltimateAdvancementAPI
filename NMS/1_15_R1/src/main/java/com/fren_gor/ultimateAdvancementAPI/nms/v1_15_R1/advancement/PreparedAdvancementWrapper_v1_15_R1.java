...
public class PreparedAdvancementWrapper_v1_15_R1 extends PreparedAdvancementWrapper {
    ...
    public PreparedAdvancementWrapper_v1_15_R1(@NotNull MinecraftKeyWrapper key, @Nullable PreparedAdvancementWrapper parent, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression) {
        this.key = key;
        this.parent = parent;
    ...
    public AdvancementWrapper toAdvancementWrapper(@NotNull AdvancementDisplayWrapper display) {
        if (parent == null) {
            return new AdvancementWrapper_v1_15_R1(key, display, advCriteria, advRequirements);
        } else {
            return new AdvancementWrapper_v1_15_R1(key, parent, display, advCriteria, advRequirements);
        }
    }
    ...
    public PreparedAdvancementWrapper withParent(@Nullable PreparedAdvancementWrapper parent) {
        return new PreparedAdvancementWrapper_v1_15_R1(key, parent, advCriteria, advRequirements);
    }
}
