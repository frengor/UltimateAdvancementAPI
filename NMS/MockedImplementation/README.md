...
This module is *not* distributed inside the [NMS/Distribution module](../Distribution), so that it'll be not included into the final artifact(s) of
UltimateAdvancementAPI.

> The mocked server version is `mocked0_0_R1`. The version number (`mocked0_0_R1`) has no particular meaning since the mocked implementation is
> version-independent.  
