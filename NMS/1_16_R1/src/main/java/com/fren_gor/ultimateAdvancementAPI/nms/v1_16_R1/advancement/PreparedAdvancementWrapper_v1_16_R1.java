...
public class PreparedAdvancementWrapper_v1_16_R1 extends PreparedAdvancementWrapper {
    ...
    protected PreparedAdvancementWrapper_v1_16_R1(@NotNull MinecraftKeyWrapper key, @Nullable PreparedAdvancementWrapper parent, @NotNull Map<String, Criterion> advCriteria, @NotNull String[][] advRequirements) {
        this.key = key;
        this.parent = parent;
    ...
    public PreparedAdvancementWrapper withParent(@Nullable PreparedAdvancementWrapper parent) {
        return new PreparedAdvancementWrapper_v1_16_R1(key, parent, advCriteria, advRequirements);
    }
}
