...
public class PreparedAdvancementDisplayWrapper_v1_21_R2 extends PreparedAdvancementDisplayWrapper {
    ...
    public PreparedAdvancementDisplayWrapper_v1_21_R2(@NotNull ItemStack icon, @NotNull String jsonTitle, @NotNull String jsonDescription, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden) throws JsonParseException {
        this.icon = CraftItemStack.asNMSCopy(icon);
