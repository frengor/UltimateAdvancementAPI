...
public class PreparedAdvancementWrapper_v1_21_R1 extends PreparedAdvancementWrapper {
    ...
    public PreparedAdvancementWrapper_v1_21_R1(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementDisplayWrapper display, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression) {
        this.key = key;
