...
public class MinecraftKeyWrapper_v1_20_R2 extends MinecraftKeyWrapper {

    private final ResourceLocation key;

    public MinecraftKeyWrapper_v1_20_R2(@NotNull Object key) {
        this.key = (ResourceLocation) key;
    }

    public MinecraftKeyWrapper_v1_20_R2(@NotNull String namespace, @NotNull String key) {
        try {
