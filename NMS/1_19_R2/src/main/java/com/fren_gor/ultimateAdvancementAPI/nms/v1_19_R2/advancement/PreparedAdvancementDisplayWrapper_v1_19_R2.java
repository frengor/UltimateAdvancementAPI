...
public class PreparedAdvancementDisplayWrapper_v1_19_R2 extends PreparedAdvancementDisplayWrapper {
    ...
    public PreparedAdvancementDisplayWrapper_v1_19_R2(@NotNull ItemStack icon, @NotNull String title, @NotNull String description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden) {
