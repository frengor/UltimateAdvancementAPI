...
public class Util {
    ...
    private static final net.minecraft.server.v1_16_R3.Advancement ROOT;
    ...
    static {
        ...
        criterion.b();
        net.minecraft.server.v1_16_R3.AdvancementDisplay display = new net.minecraft.server.v1_16_R3.AdvancementDisplay(new net.minecraft.server.v1_16_R3.ItemStack(Blocks.GRASS_BLOCK.getItem()), new ChatComponentText("§f§lNotifications§1§2§3§4§5§6§7§8§9§0"), new ChatComponentText("§7Notification page.\n§7Close and reopen advancements to hide."), new MinecraftKey("textures/block/stone.png"), net.minecraft.server.v1_16_R3.AdvancementFrameType.TASK, false, false, false);
        ROOT = new net.minecraft.server.v1_16_R3.Advancement(ROOT_KEY, null, display, ADV_REWARDS, ADV_CRITERIA_MAP, ADV_REQUIREMENTS);
