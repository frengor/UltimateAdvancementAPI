...
public class AdvancementDisplayWrapper_v1_16_R3 extends AdvancementDisplayWrapper {
    ...
    public AdvancementDisplayWrapper_v1_16_R3(@NotNull ItemStack icon, @NotNull String title, @NotNull String description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden, @Nullable String backgroundTexture) {
        ...
        this.display = new AdvancementDisplay(CraftItemStack.asNMSCopy(icon), CraftChatMessage.fromStringOrNull(title, true), CraftChatMessage.fromStringOrNull(description, true), background, (AdvancementFrameType) frameType.toNMS(), showToast, announceChat, hidden);
        this.display.a(x, y);
