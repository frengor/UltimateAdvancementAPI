...
public class AdvancementDisplayWrapper_v1_16_R2 extends AdvancementDisplayWrapper {
    ...
    public AdvancementDisplayWrapper_v1_16_R2(@NotNull ItemStack icon, @NotNull String title, @NotNull String description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean hidden, @Nullable String backgroundTexture) {
