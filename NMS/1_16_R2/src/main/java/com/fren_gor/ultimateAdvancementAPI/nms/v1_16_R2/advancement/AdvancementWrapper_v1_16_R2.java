...
public class AdvancementWrapper_v1_16_R2 extends AdvancementWrapper {
    ...
    public AdvancementWrapper_v1_16_R2(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementDisplayWrapper display, @Range(from = 1, to = Integer.MAX_VALUE) int maxCriteria) {
    ...
    public AdvancementWrapper_v1_16_R2(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementWrapper parent, @NotNull AdvancementDisplayWrapper display, @Range(from = 1, to = Integer.MAX_VALUE) int maxCriteria) {
        Map<String, Criterion> advCriteria = Util.getAdvancementCriteria(maxCriteria);
    ...
    protected AdvancementWrapper_v1_16_R2(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementWrapper parent, @NotNull AdvancementDisplayWrapper display, @NotNull Map<String, Criterion> advCriteria, @NotNull String[][] advRequirements) {
