...
public class PreparedAdvancementWrapper_v1_16_R2 extends PreparedAdvancementWrapper {
    ...
    public PreparedAdvancementWrapper_v1_16_R2(@NotNull MinecraftKeyWrapper key, @Nullable PreparedAdvancementWrapper parent, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression) {
        this.key = key;
        this.parent = parent;
    ...
    protected PreparedAdvancementWrapper_v1_16_R2(@NotNull MinecraftKeyWrapper key, @Nullable PreparedAdvancementWrapper parent, @NotNull Map<String, Criterion> advCriteria, @NotNull String[][] advRequirements) {
        this.key = key;
        this.parent = parent;
    ...
    public PreparedAdvancementWrapper withParent(@Nullable PreparedAdvancementWrapper parent) {
        return new PreparedAdvancementWrapper_v1_16_R2(key, parent, advCriteria, advRequirements);
    }
}
