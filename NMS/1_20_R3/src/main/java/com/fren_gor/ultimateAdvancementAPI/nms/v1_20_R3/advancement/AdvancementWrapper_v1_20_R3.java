...
public class AdvancementWrapper_v1_20_R3 extends AdvancementWrapper {
    ...
    protected AdvancementWrapper_v1_20_R3(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementWrapper parent, @NotNull AdvancementDisplayWrapper display, @NotNull Map<String, Criterion<?>> advCriteria, @NotNull AdvancementRequirements advRequirements) {
