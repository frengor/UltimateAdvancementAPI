...
public class MinecraftKeyWrapper_v1_20_R3 extends MinecraftKeyWrapper {

    private final ResourceLocation key;

    public MinecraftKeyWrapper_v1_20_R3(@NotNull Object key) {
        this.key = (ResourceLocation) key;
    }

    public MinecraftKeyWrapper_v1_20_R3(@NotNull String namespace, @NotNull String key) {
        try {
