...
public class AdvancementFrameTypeWrapper_v1_21_R5 extends AdvancementFrameTypeWrapper {

    private final net.minecraft.advancements.AdvancementType mcFrameType;

    private final FrameType frameType;

    public AdvancementFrameTypeWrapper_v1_21_R5(@NotNull FrameType frameType) {
