...
public class PreparedAdvancementDisplayWrapper_v1_20_R4 extends PreparedAdvancementDisplayWrapper {
    ...
    public PreparedAdvancementDisplayWrapper_v1_20_R4(@NotNull ItemStack icon, @NotNull BaseComponent title, @NotNull BaseComponent description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden) {
    ...
    public AdvancementDisplayWrapper toBaseAdvancementDisplay() {
        return new AdvancementDisplayWrapper_v1_20_R4(icon, title, description, frameType, x, y, showToast, announceChat, hidden, null);
    }
    ...
    public AdvancementDisplayWrapper toRootAdvancementDisplay(@NotNull String backgroundTexture) {
        ...
        return new AdvancementDisplayWrapper_v1_20_R4(icon, title, description, frameType, x, y, showToast, announceChat, hidden, backgroundTexture);
    }
}
