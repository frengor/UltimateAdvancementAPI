...
public class PreparedAdvancementDisplayWrapper_v1_19_R1 extends PreparedAdvancementDisplayWrapper {
    ...
    public PreparedAdvancementDisplayWrapper_v1_19_R1(@NotNull ItemStack icon, @NotNull BaseComponent title, @NotNull BaseComponent description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden) {
    ...
    public PreparedAdvancementDisplayWrapper_v1_19_R1(@NotNull ItemStack icon, @NotNull JsonString jsonTitle, @NotNull JsonString jsonDescription, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden) throws JsonParseException {
        this.icon = CraftItemStack.asNMSCopy(icon);
    ...
    public AdvancementDisplayWrapper toBaseAdvancementDisplay() {
        return new AdvancementDisplayWrapper_v1_19_R1(icon, title, description, frameType, x, y, showToast, announceChat, hidden, null);
    }
    ...
    public AdvancementDisplayWrapper toRootAdvancementDisplay(@NotNull String backgroundTexture) {
        ...
        return new AdvancementDisplayWrapper_v1_19_R1(icon, title, description, frameType, x, y, showToast, announceChat, hidden, backgroundTexture);
    }
}
