...
public class AdvancementDisplayWrapper_v1_21_R7 extends AdvancementDisplayWrapper {
    ...
    protected AdvancementDisplayWrapper_v1_21_R7(@NotNull net.minecraft.world.item.ItemStack icon, @NotNull Component title, @NotNull Component description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden, @Nullable String backgroundTexture) {
