package com.fren_gor.ultimateAdvancementAPI.nms.v26_2_R1.packets;
...
public class PacketPlayOutAdvancementsWrapper_v26_2_R1 extends PacketPlayOutAdvancementsWrapper {

    private final ClientboundUpdateAdvancementsPacket packet;

    public PacketPlayOutAdvancementsWrapper_v26_2_R1() {
    ...
    public PacketPlayOutAdvancementsWrapper_v26_2_R1(@NotNull Map<AdvancementWrapper, Integer> toSend) {
    ...
    @SuppressWarnings("unchecked")
    public PacketPlayOutAdvancementsWrapper_v26_2_R1(@NotNull Set<MinecraftKeyWrapper> toRemove) {
