...
public class VanillaAdvancementDisablerWrapper_v1_21_R3 extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements() throws Exception {
        ...
        try {
            ...
            for (var entry : serverAdvancements.advancements.entrySet()) {
                ...
                if (key.getNamespace().equals("minecraft") && (!key.getPath().startsWith("recipes/"))) {
                    locations.add(key);
                } else {
    ...
    private VanillaAdvancementDisablerWrapper_v1_21_R3() {
