...
public class MinecraftKeyWrapper_v1_18_R1 extends MinecraftKeyWrapper {

    private final ResourceLocation key;

    public MinecraftKeyWrapper_v1_18_R1(@NotNull Object key) {
        this.key = (ResourceLocation) key;
    }

    public MinecraftKeyWrapper_v1_18_R1(@NotNull String namespace, @NotNull String key) {
        try {
