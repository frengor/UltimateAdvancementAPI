...
public class PreparedAdvancementWrapper_v1_17_R1 extends PreparedAdvancementWrapper {
    ...
    public PreparedAdvancementWrapper_v1_17_R1(@NotNull MinecraftKeyWrapper key, @Nullable PreparedAdvancementWrapper parent, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression) {
        this.key = key;
        this.parent = parent;
