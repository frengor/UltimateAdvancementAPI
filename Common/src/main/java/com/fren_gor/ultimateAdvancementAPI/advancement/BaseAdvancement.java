...
public class BaseAdvancement extends Advancement {
     ...
     */
    public BaseAdvancement(@NotNull String key, @NotNull IAdvancementDisplay display, @NotNull Advancement parent) {
     ...
     */
    public BaseAdvancement(@NotNull String key, @NotNull IAdvancementDisplay display, @NotNull Advancement parent, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression) {
