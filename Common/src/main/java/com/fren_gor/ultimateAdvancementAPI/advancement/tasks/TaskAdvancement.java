...
public class TaskAdvancement extends BaseAdvancement {
     ...
     * @param multitask The {@link AbstractMultiTasksAdvancement} that owns this task.
     */
    public TaskAdvancement(@NotNull String key, @NotNull IAdvancementDisplay display, @NotNull AbstractMultiTasksAdvancement multitask) {
     ...
     * @param maxProgression The maximum progression of the task.
     */
    public TaskAdvancement(@NotNull String key, @NotNull IAdvancementDisplay display, @NotNull AbstractMultiTasksAdvancement multitask, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression) {
