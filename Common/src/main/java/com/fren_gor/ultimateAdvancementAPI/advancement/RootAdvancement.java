...
public class RootAdvancement extends Advancement {
     ...
     */
    public RootAdvancement(@NotNull AdvancementTab advancementTab, @NotNull String key, @NotNull IAdvancementDisplay display, @NotNull String backgroundTexture) {
     ...
     */
    public RootAdvancement(@NotNull AdvancementTab advancementTab, @NotNull String key, @NotNull IAdvancementDisplay display, @NotNull String backgroundTexture, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression) {
