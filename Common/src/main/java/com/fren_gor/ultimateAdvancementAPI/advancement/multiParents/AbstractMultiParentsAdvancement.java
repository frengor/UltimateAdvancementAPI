...
public abstract class AbstractMultiParentsAdvancement extends BaseAdvancement {
     ...
     * @param display The display information of this advancement.
     */
    public AbstractMultiParentsAdvancement(@NotNull BaseAdvancement aParent, @NotNull String key, @Range(from = 1, to = Integer.MAX_VALUE) int maxProgression, @NotNull AbstractAdvancementDisplay display) {
        super(aParent, key, maxProgression, display);
    }
     ...
     * The obtained parent advancement should be passed to {@link #AbstractMultiParentsAdvancement(BaseAdvancement, String, int, AbstractAdvancementDisplay)}.
