...
public class UltimateAdvancementAPICommand {
    ...
    public static void register() {
        ...
        grant.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_GRANT_TAB).withArguments(new AdvancementTabArgument("advancementTab")).executesPlayer((Player player, Object[] args) -> grantTab(player, (AdvancementTab) args[0], player, true)));
        grant.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_GRANT_TAB).withArguments(new AdvancementTabArgument("advancementTab"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> grantTab(sender, (AdvancementTab) args[0], (Player) args[1], true)));
        grant.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_GRANT_TAB).withArguments(new AdvancementTabArgument("advancementTab"), new PlayerArgument("player"), new BooleanArgument("giveRewards")).executes((CommandSender sender, Object[] args) -> grantTab(sender, (AdvancementTab) args[0], (Player) args[1], (boolean) args[2])));
        ...
        grant.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_GRANT_ONE).withArguments(new AdvancementArgument("advancement")).executesPlayer((Player player, Object[] args) -> grantOne(player, (Advancement) args[0], player, true)));
        grant.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_GRANT_ONE).withArguments(new AdvancementArgument("advancement"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> grantOne(sender, (Advancement) args[0], (Player) args[1], true)));
        grant.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_GRANT_ONE).withArguments(new AdvancementArgument("advancement"), new PlayerArgument("player"), new BooleanArgument("giveRewards")).executes((CommandSender sender, Object[] args) -> grantOne(sender, (Advancement) args[0], (Player) args[1], (boolean) args[2])));
        ...
        revoke.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_REVOKE_TAB).withArguments(new AdvancementTabArgument("advancementTab")).executesPlayer((Player player, Object[] args) -> revokeTab(player, (AdvancementTab) args[0], player, false)));
        revoke.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_REVOKE_TAB).withArguments(new AdvancementTabArgument("advancementTab"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> revokeTab(sender, (AdvancementTab) args[0], (Player) args[1], false)));
        revoke.withSubcommand(new CommandAPICommand("tab").withPermission(PERMISSION_REVOKE_TAB).withArguments(new AdvancementTabArgument("advancementTab"), new PlayerArgument("player"), new BooleanArgument("hideTab")).executes((CommandSender sender, Object[] args) -> revokeTab(sender, (AdvancementTab) args[0], (Player) args[1], (boolean) args[2])));
        ...
        revoke.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_REVOKE_ONE).withArguments(new AdvancementArgument("advancement")).executesPlayer((Player player, Object[] args) -> revokeOne(player, (Advancement) args[0], player)));
        revoke.withSubcommand(new CommandAPICommand("one").withPermission(PERMISSION_REVOKE_ONE).withArguments(new AdvancementArgument("advancement"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> revokeOne(sender, (Advancement) args[0], (Player) args[1])));
        ...
        criteria.withSubcommand(new CommandAPICommand("get").withPermission(PERMISSION_CRITERIA_GET).withArguments(new AdvancementArgument("advancement")).executesPlayer((Player player, Object[] args) -> getCriteria(player, (Advancement) args[0], player)));
        criteria.withSubcommand(new CommandAPICommand("get").withPermission(PERMISSION_CRITERIA_GET).withArguments(new AdvancementArgument("advancement"), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> getCriteria(sender, (Advancement) args[0], (Player) args[1])));
        ...
        criteria.withSubcommand(new CommandAPICommand("set").withPermission(PERMISSION_CRITERIA_SET).withArguments(new AdvancementArgument("advancement"), new IntegerArgument("criteria", 0)).executesPlayer((Player player, Object[] args) -> setCriteria(player, (Advancement) args[0], (int) args[1], player, true)));
        criteria.withSubcommand(new CommandAPICommand("set").withPermission(PERMISSION_CRITERIA_SET).withArguments(new AdvancementArgument("advancement"), new IntegerArgument("criteria", 0), new PlayerArgument("player")).executes((CommandSender sender, Object[] args) -> setCriteria(sender, (Advancement) args[0], (int) args[1], (Player) args[2], true)));
    ...
    private static void grantAll(CommandSender sender, Player p, boolean giveRewards) {
        for (AdvancementTab m : AdvancementMain.getInstance().getTabs()) {
            if (m.isActive()) {
    ...
    private static void grantTab(CommandSender sender, AdvancementTab tab, Player p, boolean giveRewards) throws WrapperCommandSyntaxException {
        if (!tab.isActive()) {
    ...
    private static void grantOne(CommandSender sender, Advancement advancement, Player p, boolean giveRewards) {
    ...
    private static void revokeAll(CommandSender sender, Player p, boolean hideTabs) {
        for (AdvancementTab m : AdvancementMain.getInstance().getTabs()) {
            for (Advancement a : m.getAdvancements()) {
                a.revoke(p);
            }
    ...
    private static void revokeTab(CommandSender sender, AdvancementTab tab, Player p, boolean hideTab) throws WrapperCommandSyntaxException {
        if (!tab.isActive()) {
            CommandAPI.fail("Advancement tab is not active.");
        }
        for (Advancement a : tab.getAdvancements()) {
    ...
    private static void revokeOne(CommandSender sender, Advancement advancement, Player p) {
    ...
    private static int getCriteria(CommandSender sender, Advancement advancement, Player player) {
    ...
    private static void setCriteria(CommandSender sender, Advancement advancement, int criteria, Player player, boolean giveRewards) {
